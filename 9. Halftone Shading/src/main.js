...
const processedhalftoneFragmentShader = halftoneFragmentShader
  .replace('#include ../includes/ambientLight.glsl',ambientLight)
  .replace('#include ../includes/directionalLight.glsl',directionalLight)

const material = new THREE.ShaderMaterial({
    vertexShader: halftoneVertexShader,
    // fragmentShader: halftoneFragmentShader,
    fragmentShader: processedhalftoneFragmentShader,
    uniforms:
    {
